...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.93\textwidth]{figures/Figure_S4.pdf}
...
\begin{finished_ourresponse}
    ...
    {\bfseries
        ...
        For phase retrieval, following Katz et al. \cite{katz14}, we ran 500 independent runs of the following phase-retrieval algorithms, where in each run a different random initial guess for the object was used, and the lowest error reconstruction is presented in Fig.~\ref {supp_fig:comparison},:
        \begin{enumerate}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.93\linewidth]{figures/figure_S5.pdf}
