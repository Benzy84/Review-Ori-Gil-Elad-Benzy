...
Thirdly, we have performed a numerical study on the effects of imperfect (in)homogeneous illumination on reconstruction fidelity in the case of coherent imaging. The study focuses on the case of a single coherent illumination with a focused beam.
...
\begin{ourresponse}
    We appreciate the reviewer's concern about the isoplanatic patch limitation. We note that we had already mentioned this constraint in the opening paragraph of the Principle section, highlighting that: 
    \begin{quote}
...
\begin{ourresponse}
    ...
    To comprehensively address this point, we have added a new supplementary section titled "Digital Autofocus through Fresnel Propagation" that demonstrates this capability in detail.
